...
| `clonality-ml-v0.2.0-app-integration` | 2026-07-13 | `app-integration` | n/a (no new training run; v0.1.0 models re-used) | per-assay, see metadata.json | re-uses Phase 5 calibration | In-app model store, Settings Browse, TabMlTraining, per-sample HTML badge with dismiss+Save-Peaks round-trip, runtime ML attachment. | _shipped_ |

...
4. Optional ML second-opinion: when interpretation is enabled,
   ...
   promoted, deduplicated, class-support- and run-group-validated v6 per-assay
   artifact. It recomputes raw trace features when needed and leaves the rule
   output unchanged.
...
- validated runtime model schema: `ml_training_pipeline_v6`
